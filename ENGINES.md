...
```bash
/opt/n8n-install/shims/remotion --version
...
- После обновления n8n `update_n8n.sh` сам прогоняет `remotion --version` / `render-html --help` и пишет в Telegram, если что-то не отвечает.

...
| Post-check | 🔧 добавлен: после обновления проверяются `remotion --version`, `render-html --help`, `ffmpeg`, `edge-tts`, шимы в n8n-app; при сбое — сообщение в Telegram |
